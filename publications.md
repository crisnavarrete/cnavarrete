...
```{=html}
<ul class='list-group list-group-flush'><li class='list-group-item'>Dave Elder-Vass, Tom Fryer, Ruth Porter Groff, <strong>Cristián Navarrete</strong>, and Tobin Nelhaus. (2023) "Does critical realism need the concept of three domains of reality? A roundtable. Journal of Critical Realism."<br><a class="btn btn-outline-dark btn-sm", href="https://tandfonline.com/doi/full/10.1080/14767430.2023.2180965" target="_blank" rel="noopener noreferrer">
        <i class="ai ai-archive" role='img' aria-label='Published'></i>
        Published
    </a></li></ul>
```
